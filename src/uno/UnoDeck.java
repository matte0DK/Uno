...
public class UnoDeck {
    ...
    public void reset() {
        ...
        // METHOD TO SWITCH CURRENT DECK (!WHEN EMPTY!) WITH STOCKPILE OF PLAYED CARDS
    public void replaceDeckWith(ArrayList<UnoCard> cards) {
        ...
        // METHOD TO CHECK IF THE CARDS IN THE DECK ARE EMPTY
